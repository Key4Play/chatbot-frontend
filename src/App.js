  ...
  const theme = createTheme(
    {
      ...
      palette: {
        type: mode,
        primary: { main: mode === "light" ? "#016056" : "#FFFFFF" },
        textPrimary: mode === "light" ? "#016056" : "#FFFFFF",
        borderPrimary: mode === "light" ? "#016056" : "#FFFFFF",
        ...
        barraSuperior:
          mode === "light"
            ? "linear-gradient(to right, #016056, #016056 , #016056)"
            : "#666",
